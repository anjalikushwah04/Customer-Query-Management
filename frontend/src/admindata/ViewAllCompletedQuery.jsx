...
const Viewcompletedquery = () => {
    const { id } = useParams();
    const [depart, setDepart] = useState("")
    const [subject, setSubject] = useState("")
    const [query, setQuery] = useState("")
    const getUser = async () => {
        const response = await fetch(`http://localhost:8000/viewallcompletedquery/${id}`)
        if (response.ok) {
            ...
            <div className="row vh-90">
                ...
                <div className="col-10 scroll h-100 bg-success bg4">
                    <div className="row mt-5 h-100 ">
                        <div className="col-md-6 my-auto mx-auto  p-3 rounded shadow-lg text-white">
                            <h5 className="text-center p-2 text-dark  bg-warning">View All Completed Query</h5>
...
export default Viewcompletedquery