      ...
      <div className="row vh-90">
        ...
        <div className="col-10 scroll h-100 bg-success bg4">
          <div className="row mt-5 h-100">
            <div className="col-md-6 my-auto mx-auto text-white blur1 p-5 rounded shadow-lg text-black">
              ...
              <div className="row p-2">
                <Link to={`/editadmindetails/${id}`} className='btn btn-info rounded-5'>Edit</Link>
              </div>
            </div>
          </div>
        </div>
