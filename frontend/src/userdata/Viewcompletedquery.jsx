...
const Viewcompletedquery = () => {
    ...
    const getUser = async () => {
        const response = await fetch(`http://localhost:8000/viewcompletedquery/${id}`)
        if (response.ok) {
            ...
            <div className="row vh-90">
                ...
                <div className="col-10 scroll h-100 bg-success  bg3">
                    <div className="row mt-5 h-100 ">
                        <div className="col-md-6 my-auto mx-auto  p-3 rounded shadow-lg text-white blur5">
                            <h5 className="text-center p-2 text-dark  bg-warning">View Completed Query</h5>
